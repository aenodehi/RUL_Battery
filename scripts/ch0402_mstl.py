...
from src.models.statsforecast_models import Naive, ARIMA, TBATS, MSTL
...
fig.write_image(str(output_dir / "mstl.png"))
fig.write_html(str(output_dir / "mstl_forecast.html"))

print("✅ Forecast plots saved:")
print(f" - Static PNG: {output_dir / 'mstl.png'}")
print(f" - Interactive HTML: {output_dir / 'mstl_forecast.html'}")
