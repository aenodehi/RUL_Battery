...
from src.models.statsforecast_models import Naive, ARIMA
...
fig.write_image(str(output_dir / "arima.png"))
fig.write_html(str(output_dir / "arima_forecast.html"))

print("✅ Forecast plots saved:")
print(f" - Static PNG: {output_dir / 'arima.png'}")
print(f" - Interactive HTML: {output_dir / 'arima_forecast.html'}")
