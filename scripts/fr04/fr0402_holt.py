...
from src.models.statsforecast_models import Naive, WindowAverage, HoltWinters
...
fig.write_image(str(output_dir / "holtwinter.png"))
fig.write_html(str(output_dir / "holtwinter_forecast.html"))

print("✅ Forecast plots saved:")
print(f" - Static PNG: {output_dir / 'holtwinter.png'}")
print(f" - Interactive HTML: {output_dir / 'holtwinter_forecast.html'}")
