...
from src.models.statsforecast_models import Naive, AutoETS
...
fig.write_image(str(output_dir / "autoets.png"))
fig.write_html(str(output_dir / "autoets_forecast.html"))

print("✅ Forecast plots saved:")
print(f" - Static PNG: {output_dir / 'autoets.png'}")
print(f" - Interactive HTML: {output_dir / 'autoets_forecast.html'}")
