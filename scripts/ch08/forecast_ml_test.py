# This file is Forecasting with ML for test dataset
...
try:
    baseline_metrics_df = pd.read_pickle(preprocessed/"B0005/single_step_backtesting_baseline_metrics_test_df.pkl")
    baseline_aggregate_metrics_df = pd.read_pickle(preprocessed/"B0005/single_step_backtesting_baseline_aggregate_metrics_test.pkl")
except FileNotFoundError:
    display(HTML("""
    <div class="alert alert-block alert-warning">
...
#with open(output_img/"agg_metrics_test.html", "w") as f:
#    f.write(html)
