...
from src.models.statsforecast_models import Naive, ARIMA, TBATS
...
fig.write_image(str(output_dir / "tbats.png"))
fig.write_html(str(output_dir / "tbats_forecast.html"))

print("✅ Forecast plots saved:")
print(f" - Static PNG: {output_dir / 'tbats.png'}")
print(f" - Interactive HTML: {output_dir / 'tbats_forecast.html'}")
