...
try:
    pred_df = pd.read_pickle(output/"dl_seq_2_seq_w_attn_prediction_val_df_B0005.pkl")
    metric_record = joblib.load(output/"dl_seq_2_seq_w_attn_metrics_val_df_B0005.pkl")
    ...
    display(HTML("""
    <div class="alert alert-block alert-warning">
    <b>Warning!</b> File not found. Please make sure you have run seq2seq RNN with Attention in Chapter14
    </div>
    """))

# display_metrics(metric_record)
...
# 1. Transformer Model with Multi-step FF Decoder
...
output_path = output_img / "metric_record_transformers.html"
display_metrics(metric_record, save_path=output_path)

pred_df.to_pickle(output/"dl_transformers_val_df_B0005.pkl")
joblib.dump(metric_record, output/"dl_transformers_metrics_val_df_B0005.pkl")
