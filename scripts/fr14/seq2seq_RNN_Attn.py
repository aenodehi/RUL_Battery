# This is the main code for Seq to Seq RNN with Attention
...
try:
    pred_df = pd.read_pickle(output/"dl_seq_2_seq_prediction_val_df_B0005.pkl")
    metric_record = joblib.load(output/"dl_seq_2_seq_metrics_val_df_B0005.pkl")
    ...
    display(HTML("""
    <div class="alert alert-block alert-warning">
    <b>Warning!</b> File not found. Please make sure you have run seq2seq RNN in Chapter13
    </div>
    """))
...
# 1. LSTM-LSTM Seq2Seq With Dot Product Attention
attn = "dot"
...
# 2.LSTM-LSTM Seq2Seq With Scaled Dot Product Attention
attn = "scaled_dot"
encoder_config = RNNConfig(
        input_size=1,
        hidden_size=128,
...
# 3. LSTM-LSTM Seq2Seq With General Attention
attn = "general"
encoder_config = RNNConfig(
        input_size=1,
        hidden_size=128,
...
# 4. LSTM-LSTM Seq2Seq With Concat Attention
attn = "concat"
encoder_config = RNNConfig(
        input_size=1,
        hidden_size=128,
...
# 5. LSTM-LSTM Seq2Seq With Additive Attention
attn = "additive"
encoder_config = RNNConfig(
        input_size=1,
        hidden_size=128,
...
output_path = output_img / "metric_record_seq2seq_RNN_Attn.html"
display_metrics(metric_record, save_path=output_path)

pred_df.to_pickle(output/"dl_seq_2_seq_w_attn_prediction_val_df_B0005.pkl")
joblib.dump(metric_record, output/"dl_seq_2_seq_w_attn_metrics_val_df_B0005.pkl")
